...
public class ObjectFactory {
    ...
    private final static QName _SayHelloResponse_QNAME = new QName("http://tempuri.org", "sayHelloResponse");
    private final static QName _DownloadResponse_QNAME = new QName("http://tempuri.org", "downloadResponse");
    private final static QName _Download_QNAME = new QName("http://tempuri.org", "download");
    private final static QName _SayHello_QNAME = new QName("http://tempuri.org", "sayHello");
    private final static QName _DownloadResponseReturn_QNAME = new QName("", "return");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: swa
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org", name = "sayHello")
