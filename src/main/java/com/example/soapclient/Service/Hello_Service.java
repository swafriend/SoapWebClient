 ...
 * 
 */
@WebServiceClient(name = "Hello", targetNamespace = "http://soapservice2.example.com", wsdlLocation = "file:/D:/work/study/SoapClient/src/main/java/com/example/soapclient/Service/Hello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLO_QNAME = new QName("http://soapservice2.example.com", "Hello");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/work/study/SoapClient/src/main/java/com/example/soapclient/Service/Hello.wsdl");
    ...
    public Hello getHello() {
        return super.getPort(new QName("http://soapservice2.example.com", "Hello"), Hello.class);
    }
    ...
    public Hello getHello(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapservice2.example.com", "Hello"), Hello.class, features);
    }
